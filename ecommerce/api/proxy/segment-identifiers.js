...
export default function handler(req, res) {
  ...
  const targetUrl = `https://profiles.segment.com/v1/spaces/spa_7NoLrHoQfgv2NzMpNucoPs/collections/users/profiles/anonymous_id:${anonymousId}/external_ids?limit=25`;
  const headers = {
    'Authorization': AUTH,
